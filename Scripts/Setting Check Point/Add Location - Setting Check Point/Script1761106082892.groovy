...
WebUI.setText(findTestObject('Setting Check Point/Add New Location/Page_Gala Dinner MMS GROUP Indonesia - Admin Dashboard/input_Location-Add'), 
    'Testing From CFX Tower')

WebUI.selectOptionByLabel(findTestObject('Setting Check Point/Add New Location/Page_Gala Dinner MMS GROUP Indonesia - Admin Dashboard/select_is Bus_Add'), 
    'Yes', false)

WebUI.selectOptionByLabel(findTestObject('Setting Check Point/Add New Location/Page_Gala Dinner MMS GROUP Indonesia - Admin Dashboard/select_Status_Add'), 
    'Inactive', false)
